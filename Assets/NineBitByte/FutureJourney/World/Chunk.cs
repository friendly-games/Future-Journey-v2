...
namespace NineBitByte.FutureJourney.World
{
  ...
  public unsafe class Chunk
  {
    ...
    {
      var x = absoluteIndex % NumberOfGridItemsWide;
      var y = (absoluteIndex - x) / NumberOfGridItemsWide;
    ...
    private delegate void UpdateGridItemPropertyCallback<in T>(GridItem* gridItem, T value);
